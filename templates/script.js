$(document).ready(function() {
  ...
  var TITLE = 'Cost of Living Index by Middle Range Salary for Data Scientists';

  var POINT_X = 'middle_range_salary'; // column name for x values in working_table2.csv
  var POINT_X_PREFIX = '$'; // prefix for x values, eg '$'
  var POINT_X_POSTFIX = ''; // postfix for x values, eg '%'

  var POINT_Y = 'cost_of_living_index'; // column name for y values in working_table2.csv
  var POINT_Y_PREFIX = ''; // prefix for x values, eg 'USD '
  var POINT_Y_POSTFIX = ''; // postfix for x values, eg ' kg'

  var POINT_NAME = 'state'; // point names that appear in tooltip
  var POINT_COLOR = 'rgba(0,0,255,0.7)'; // eg `black` or `rgba(10,100,44,0.8)`
  var POINT_RADIUS = 5; // radius of each data point

  var X_AXIS = 'Middle Range Salary for Data Scientist'; // x-axis label, label in tooltip
  var Y_AXIS = 'Cost of Living Index'; // y-axis label, label in tooltip

  var SHOW_GRID = true; // `true` to show the grid, `false` to hide

  // Read data file with random string generated by current time
  // to bypass browser cache, and create chart
  $.get('../data/working_table2.csv', {'_': $.now()}, function(csvString) {
